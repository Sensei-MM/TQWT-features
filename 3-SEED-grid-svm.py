...
def band_accuracy(data):
    ...
    c_para = list(np.arange(2**-10,2**10,1))
    tuned_parameters = [{'kernel': ['linear'], 'C': c_para}]
    scores = [ 'accuracy']
    for score in scores:
...
if __name__ == '__main__':
    ...
    with pd.ExcelWriter('G:\Paper-EEG Emotion\SEED-tqwt2-8band-q1r3j7-2\Analysis-Trditional\\svm-de0.5-grid.xlsx') as writer:
        dataframe.to_excel(writer, sheet_name='de-q1r3j7-8band-svm-day1')